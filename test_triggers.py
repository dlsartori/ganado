...
from krnl_config import DB_REPLICATE, tables_and_binding_objects, tables_and_methods, baptize_db, MAIN_DB_ID, time_mt
...
sys_db_id_trigg = 'UPDATE "_sys_db_id" SET "DB_ID" = "MOMMA" WHERE ID_ROW=3214041033; '
