...
class SqliteExtDatabase(SqliteDatabase):        # class SqliteExtDatabase(SqliteDatabase):
...
def bm25(raw_match_info, *args):
    ...
    P_O, C_O, N_O, A_O = range(4)  # Offsets into the matchinfo async_buffer.
    ...
    #   lote1 = 30  -- curr doc has 30 tokens in col1
    #
