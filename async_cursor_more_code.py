...
# peewee/peewee.py /
# @coleifer
# coleifer Add helper to reduce base-model boilerplate per #2637
# Latest commit 3ca1885 yesterday
# History
# 58 contributors
# @coleifer
# @giohappy
...
class _manual(_callable_context_manager):
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if self.db.pop_transaction() is not self:
            raise ValueError('TransactionActivity stack corrupted while exiting '
                             'manual commit block.')
...
#     About
#
# peewee/peewee.py at 3ca18852f776e9417a9248d662e8f929171b9259 · coleifer/peewee · GitHub